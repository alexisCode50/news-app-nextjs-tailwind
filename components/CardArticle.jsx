		...
		<article className="w-full bg-white shadow-md border border-gray-200 rounded-lg">
            ...
            <div className="p-5">
              	<p className="mb-3 text-xs font-semibold tracking-wide uppercase">
	                <a target="_blank" rel="noopener" href={article.url} className="transition-colors duration-200 text-blue-gray-900 hover:text-deep-purple-accent-700">
	                  { article.source.name }
	                </a>
              	...
              	<a target="_blank" rel="noopener" href={article.url} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center">
                	Read more
              	</a>
            </div>
        </article>
