                      ...
                      <div className="md:h-80 flex flex-col sm:flex-row bg-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="w-full sm:w-1/2 lg:w-3/5 flex flex-col p-4 sm:p-8">
                          ...
                          <div className="mt-auto">
                            <a target="_blank" href={article.url} className="inline-block bg-white hover:bg-gray-100 active:bg-gray-200 focus-visible:ring ring-indigo-300 text-gray-800 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                              Read more
                            </a>
                          </div>
                        </div>
